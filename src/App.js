    ...
    <div className="App">
      <nav id="main-menu">
        ...
        <ul id="right-menu">
            ...
            <li id="profile" style="flex-basis: 60px;">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
    ...
    <main id="main" data-id="0">
        <aside id="left-sidebar">
            ...
            <section class="emissions-section" data-id="0">
                ...
                <div class="custom-range">
                    <input style="margin-bottom: 15px;" type="text" class="from-date cb-input" placeholder="From Date"/>
        ...
        <div id="main-content">
            ...
            <section class="locations-list-section">
                <div class="locations-list-right">
                    <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d95010.19695703337!2d-87.86913026336047!3d41.91288281686306!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x880e2cbd75b9e3b7%3A0xc0f3325c61940e15!2sAVA%20Recycling%20Pick%20Up%2C%20Asset%20Recovery%20and%20Shredding!5e0!3m2!1sen!2sbd!4v1649935376358!5m2!1sen!2sbd" style="border:0;" allowfullscreen="" width="100%" height="350" frameborder="0"></iframe>
            ...
            <section class="help-section">
                <h2 style="margin-bottom: 15px;">Help</h2>
        ...
        <aside id="right-sidebar">
            <div class="choices-section-right-first">
                <h2 style="color: #d81e5b; margin-bottom: 30px;">Journey Summary</h2>
                <h3 style="margin-bottom: 15px;">Step 1: Garbage info</h3>
                <p>5 Plastic bottles, 3 Glass cups, 2 Cardboard boxes & 2lb Food waste</p>
                <button style="margin-top: 15px;" class="cb-button cb-btn-chevron cb-btn-chevron-left cb-btn-chevron-white" id="choices-prev">Update garbage info</button>
                <h3 style="margin:  15px 0;">Step 2: <span style="color: #d81e5b;">You're here now</span></h3>
                <h3 style="margin-bottom: 30px;">Step 3: Results</h3>
            </div>
            <div class="choices-section-right">
                ...
                <h3 style="margin-bottom: 30px;">Step 3: <span style="color: #d81e5b;">You're here now</span></h3>
            </div>
            <div class="quick-look">
                <h2 style="color: #d81e5b; margin-bottom: 30px;">Quick Look</h2>
                <div>
                    ...
                    <ul style="margin: 20px 0; padding-left: 15px;" class="pie-list active">
